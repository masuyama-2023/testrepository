...
public class RemainDaysCount {
    ...
    private static Calendar getCalendarFor(String yyyymmdd) throws ParseException {
        final Date date = RemainDaysCount.validateAndParseDate(yyyymmdd);
    ...
    public static String[] getDaysStrBetween(String from, String to) throws ParseException {
        ...
        int howManyDays = RemainDaysCount.countDaysBetween(fromC.getTime(), toC.getTime()) + 1;
